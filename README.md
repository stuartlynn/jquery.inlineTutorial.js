jquery.inlineTutorial.js is a jQuery UI plugin to allow quick and easy inline tutorials for websites. You can see it in action at whales.zooniverse.org
